  ...
  return (
    <section ref={sectionRef} className="relative py-28 sm:py-32">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 60% 50% at 50% 100%, rgba(200,255,60,0.04) 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      ...
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        <div ref={headRef} className="mx-auto mb-14 max-w-2xl text-center">
          ...
          <p className="mx-auto mt-5 section-subheading">
            A single CLI that auto-detects your framework and handles the rest.
            No YAML files, no config ceremony.
          </p>
        </div>

        <div
          ref={termRef}
          className="relative mx-auto max-w-160 overflow-hidden rounded-2xl border border-[rgba(232,230,225,0.08)] bg-void-warm shadow-[0_0_0_1px_rgba(200,255,60,0.04),0_24px_64px_rgba(0,0,0,0.5),0_0_120px_rgba(200,255,60,0.03)] before:pointer-events-none before:absolute before:inset-0 before:rounded-[inherit] before:bg-[linear-gradient(135deg,rgba(200,255,60,0.04)_0%,transparent_40%,transparent_60%,rgba(200,255,60,0.02)_100%)] before:content-['']"
        >
          ...
          <div className="min-h-[280px] px-7 py-7 font-mono text-[0.8125rem] leading-8 text-ash">
            {COMMANDS.slice(0, visibleLines).map((line, lineIndex) => (
              ...
              >
                {line.type === "cmd" && (
                  <span className="select-none text-phosphor">$</span>
                )}
        ...
        <div className="mt-8 flex flex-col items-center gap-3">
          ...
          >
            ...
            <svg
              ...
              viewBox="0 0 14 14"
              fill="none"
              className="text-ash transition-colors duration-200 group-hover:text-phosphor"
              aria-hidden="true"
            >
              <rect
                x="1"
              ...
              />
              <path
                d="M4 3V1.5A.5.5 0 014.5 1h8a.5.5 0 01.5.5v8a.5.5 0 01-.5.5H11"
                stroke="currentColor"
                strokeWidth="1.25"
              />
            </svg>
