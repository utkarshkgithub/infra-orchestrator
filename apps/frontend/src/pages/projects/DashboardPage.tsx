      ...
      <div className="max-w-[1100px] mx-auto px-8 py-8">
        ...
        <div className="flex items-center gap-3 mb-6 flex-wrap">
          ...
          <div className="flex items-center gap-2 ml-auto">
            ...
            <Link
              to="/projects/new"
              className="inline-flex items-center gap-1.5 px-3 py-2 text-[13px] font-medium bg-black dark:bg-d-fg text-white dark:text-d-bg border border-transparent rounded-lg no-underline cursor-pointer transition-all duration-150 hover:opacity-85"
            >
              <svg
                width="14"
                height="14"
      ...
      <div className="flex flex-col px-5 pt-4 pb-5">
        <div className="flex items-center gap-2.5 mb-2.5">
          ...
          <div className="flex-1 min-w-0">
            <span className="block text-[15px] font-semibold text-black dark:text-d-fg overflow-hidden text-ellipsis whitespace-nowrap">
              {project.name}
            </span>
            {dep?.status === "success" && (
              <span className="block text-[11px] text-neutral-400 dark:text-d-400 overflow-hidden text-ellipsis whitespace-nowrap">
        ...
        <div className="flex items-center mt-3 pt-3 border-t border-neutral-100 dark:border-d-100">
          ...
          <span className="text-[12px] text-neutral-400 dark:text-d-400 ml-auto">
...
function ProjectListItem({ project }: { project: ProjectWithDeployment }) {
  ...
  return (
    <Link
      to={`/projects/${project.id}`}
      className="flex items-center px-5 py-3.5 no-underline text-inherit border-b border-neutral-100 dark:border-d-100 last:border-b-0 transition-colors duration-150 hover:bg-neutral-50 dark:hover:bg-d-50"
    >
      <div className="flex items-center gap-3 flex-1 min-w-0">
        ...
        <div className="flex flex-col gap-0.5 min-w-0">
          <span className="text-[14px] font-semibold text-black dark:text-d-fg overflow-hidden text-ellipsis whitespace-nowrap">
            {project.name}
          </span>
          <span className="text-[12px] text-neutral-500 dark:text-d-500 overflow-hidden text-ellipsis whitespace-nowrap">
            {extractRepoName(project.repoUrl)}
          </span>
        </div>
      </div>
